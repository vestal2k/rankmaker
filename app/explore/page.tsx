        ...
        <div className="flex items-center justify-between gap-4 mb-10 flex-wrap">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-500 font-medium">Discover amazing tier lists</p>
            </div>
          </div>
          <Link href="/create">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            <div className="card-cartoon p-10 inline-block">
              ...
              <h2 className="text-2xl font-bold mb-3 text-zinc-900 dark:text-white">No tier lists yet!</h2>
              <p className="text-zinc-500 mb-8 text-lg max-w-md mx-auto">
